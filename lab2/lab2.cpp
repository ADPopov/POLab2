...
BEGIN_MESSAGE_MAP(Clab2App, CWinApp)
	...
	ON_BN_CLICKED(IDC_BUTTON2, &Clab2App::OnBnClickedButtonRight)
	ON_BN_CLICKED(IDC_BUTTON1, &Clab2App::OnBnClickedButtonLeft)
	ON_BN_CLICKED(IDC_BUTTON5, &Clab2App::OnBnClickedButtonMoveBtn)
END_MESSAGE_MAP()
...
void Clab2App::OnBnClickedButtonRight()
{
...
void Clab2App::OnBnClickedButtonLeft()
{
	// TODO: добавьте свой код обработчика уведомлений
}
...
void Clab2App::OnBnClickedButtonMoveBtn()
{
	// TODO: добавьте свой код обработчика уведомлений
}
